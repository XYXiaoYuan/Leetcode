...
//class Solution {
    ...
    public func getRangeSum(_ fenwickTree: inout[Int], _ i:Int) -> Int {
        var sum = 0
        var index = i + 1
        while index > 0
        {
    ...
    public func update(_ fenwickTree: inout [Int], _ rangeIndex:Int, _ val:Int) {
    ...
    public func countSmaller(_ nums: [Int]) -> [Int] {
        if nums.count == 0
        {
            return []
        }
