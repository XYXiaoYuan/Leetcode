...
func redraimentMoveWays(_ num: Int, _ line: String) -> Int {
    let line2Arr: [String] = line.components(separatedBy: " ")
    var heights: [Int] = [Int]()
